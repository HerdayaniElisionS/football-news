...
from main.views import show_main, create_news, show_news, show_xml, show_json, show_xml_by_id, show_json_by_id, add_news_entry_ajax
...
from main.views import (
    ...
    show_xml_by_id, show_json_by_id, add_news_entry_ajax,
